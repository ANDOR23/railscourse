class AmigosController < ApplicationController
  ...
  def correct_user
    ...
    redirect_to amigos_path, notice: "No estás autorizado para realizar la acción" if @amigo.nil?
  end
  ...
  private
    ...
    def amigo_params
      params.require(:amigo).permit(:primer_nombre, :apellido, :correo, :telefono, :twitter, :user_id)
    end
end
